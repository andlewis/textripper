...
namespace TextRipper.Web.TextRipperApi {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="TextRipperSoap", Namespace="http://tempuri.org/")]
    public partial class TextRipper : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public TextRipper() {
            this.Url = global::TextRipper.Web.Properties.Settings.Default.TextRipper_Web_TextRipperApi_TextRipper;
        ...
        public string GetText([System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] buffer, string contentType) {
        ...
        /// <remarks/>
        public void GetTextAsync(byte[] buffer, string contentType) {
            this.GetTextAsync(buffer, contentType, null);
        }
        
        /// <remarks/>
        public void GetTextAsync(byte[] buffer, string contentType, object userState) {
            ...
            this.InvokeAsync("GetText", new object[] {
                        buffer,
                        contentType}, this.GetTextOperationCompleted, userState);
        }
